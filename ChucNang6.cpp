...
void thongKeSachDangMuon()
{
	...
	else
	{
		...
		printf("\t\tบ                          TONG SO SACH DANG DUOC MUON: %i                  บ\n", real_total);
		printf("\t\tฬอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออน\n");
		printf("\t\tบ    ISBN      ณ                 TEN                  ณ        SO LUONG     บ\n");
		printf("\t\tบ              ณ                                      ณ                     บ\n");
		for (int i = 0; i < total; i++)
		{
			printf("\t\tบ%i) %-11s", i + 1, (maSach + i)->isbn);
			timSachTheoISBN((maSach + i)->isbn, tenSach);
			printf("ณ%-37s ", tenSach);
			printf("ณ           %-10d", *(a + i));
			printf("บ\n");
		}
		printf("\t\tบ              ณ                                      ณ                     บ");
		printf("\n\t\tศออออออออออออฯออออออออออออออออออออออออออออออออออออออฯออออออออออออออออออออออผ\n");
	}
}
...
void thongKeDocGiaTreHan()
{
	...
	else
	{
		...
		printf("\t\tฬออออออออออออออุออออออออออออออออออออออออออออออออออออออุอออออออออออออออออออออน\n");
...
void thongKeSach()
{
	...
	printf("\t\tบ                         TONG SO SACH TRONG THU VIEN: %i                   บ\n",total);
